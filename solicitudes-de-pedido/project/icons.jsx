// Iconos SVG inline — stroke-based, estilo Lucide minimalista
...
const Icon = ({ name, size = 16, className = '', strokeWidth = 1.75 }) => {
  ...
  const paths = {
    ...
    invoice: <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><path d="M8 13h6M8 17h4" /></>,
